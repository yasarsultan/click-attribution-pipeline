...
select
    ...
    max(case when touch_order_last = 1 then channel end) as attributed_channel,
    max(case when touch_order_last = 1 then source end) as attributed_source,
    max(case when touch_order_last = 1 then medium end) as attributed_medium,
